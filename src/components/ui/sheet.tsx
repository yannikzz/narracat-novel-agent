  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 border-border bg-floating text-foreground shadow-[var(--shadow-floating)] backdrop-blur-2xl transition ease-in-out [-webkit-app-region:no-drag] data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:animate-in data-[state=open]:duration-200",
          side === "right" &&
